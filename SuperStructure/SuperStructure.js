...
var SuperStructure = /** @class */ (function () {
     ...
     */
    SuperStructure.prototype.AddNode = function (TreeNode, newEnt, Height) {
     ...
     */
    SuperStructure.prototype.Rebalance = function (TreeNode) {
    ...
    SuperStructure.prototype.RotateLeft = function (TreeNode) {
    ...
    SuperStructure.prototype.RotateRight = function (TreeNode) {
    ...
    SuperStructure.prototype.RotateRightLeft = function (TreeNode) {
        var child = TreeNode.right;
    ...
    SuperStructure.prototype.RotateLeftRight = function (TreeNode) {
        var child = TreeNode.left;
     ...
     */
    SuperStructure.prototype.DeleteNode = function (current, k, Depth) {
        ...
        if (current.balance == 2 || current.balance == -2) {
            current = this.RebalanceAfterDeletion(current);
            Depth.heightChangedOnDelete = false;
        }
        return current;
    };
    /**
     * RebalanceAfterDeletion method :
     * @param TreeNode
     * returns an Entry<K, V>
     *
     * It used for rebalancing of tree after deletion
     */
    SuperStructure.prototype.RebalanceAfterDeletion = function (TreeNode) {
        if (TreeNode.balance == 2) {
